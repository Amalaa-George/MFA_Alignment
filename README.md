...
### This project demonstrates **forced alignment** of speech audio with text transcriptions using the **Montreal Forced Aligner (MFA)** toolkit and visualization in **Praat**. It aligns each word and phoneme in a spoken utterance to its corresponding time interval in the waveform.
---
...
After alignment:
Download and extract Praat (64-bit) from \
